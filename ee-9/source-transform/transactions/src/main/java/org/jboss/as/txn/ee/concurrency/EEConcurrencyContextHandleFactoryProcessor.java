...
public class EEConcurrencyContextHandleFactoryProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        final TransactionContextHandleFactory transactionContextHandleFactory = new TransactionContextHandleFactory();
        phaseContext.requires(TransactionManagerService.INTERNAL_SERVICE_NAME, transactionContextHandleFactory.getTransactionManagerSupplier());
        eeModuleDescription.getConcurrentContext().addFactory(transactionContextHandleFactory);
        final ComponentConfigurator componentConfigurator = new ComponentConfigurator() {
            ...
            public void configure(DeploymentPhaseContext context, ComponentDescription description, final ComponentConfiguration configuration) {
                ...
                final TransactionContextHandleFactory transactionContextHandleFactory = new TransactionContextHandleFactory();
                context.requires(TransactionManagerService.INTERNAL_SERVICE_NAME, transactionContextHandleFactory.getTransactionManagerSupplier());
                configuration.getConcurrentContext().addFactory(transactionContextHandleFactory);
            }
        };

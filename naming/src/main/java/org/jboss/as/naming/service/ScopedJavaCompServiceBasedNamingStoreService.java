 ...
 */
public class ScopedJavaCompServiceBasedNamingStoreService extends ServiceBasedNamingStoreCompositionService {

    private final InjectedValue<ServiceBasedNamingStore> sharedJavaCompServiceBasedNamingStore = new InjectedValue<>();

    public ScopedJavaCompServiceBasedNamingStoreService() {
        super(ContextNames.JAVA_COMP_NAME);
    }

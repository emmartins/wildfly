...
public class DsDeploymentActivator {
    ...
    public void activateProcessors(final DeploymentProcessorTarget updateContext) {
        ...
        updateContext.addDeploymentProcessor(DataSourcesExtension.SUBSYSTEM_NAME, Phase.PARSE, Phase.PARSE_DATA_SOURCE_DEFINITION_ANNOTATION, new DataSourceDefinitionAnnotationProcessor());
        updateContext.addDeploymentProcessor(DataSourcesExtension.SUBSYSTEM_NAME, Phase.POST_MODULE, Phase.POST_MODULE_RESOURCE_DEF_DESC_DATA_SOURCE, new DataSourceDefinitionDescriptorProcessor());

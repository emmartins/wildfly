...
import org.jboss.as.naming.service.ScopedJavaCompServiceBasedNamingStoreService;
...
public final class ComponentInstallProcessor implements DeploymentUnitProcessor {
    ...
    protected void deployComponent(final DeploymentPhaseContext phaseContext, final ComponentConfiguration configuration, final List<ServiceName> jndiDependencies, final ServiceName bindingDependencyService) throws DeploymentUnitProcessingException {
        ...
        final ServiceName createServiceName = componentDescription.getCreateServiceName();
        final ServiceName startServiceName = componentDescription.getStartServiceName();
        ...
        if (componentDescription.getNamingMode() == ComponentNamingMode.CREATE) {
            ...
            final ScopedJavaCompServiceBasedNamingStoreService contextService = new ScopedJavaCompServiceBasedNamingStoreService();
            phaseContext.getServiceTarget().addService(componentDescription.getContextServiceName(), contextService)
            ...
            final InjectionSource.ResolutionContext resolutionContext = new InjectionSource.ResolutionContext(
                    ...
                    componentBindingsConfiguration.getDeploymentBindings()
            ...
            Set<ServiceName> servicesBound = componentBindingsConfiguration.doBindings(phaseContext, resolutionContext, serviceVerificationHandler);
            ...
            ServiceName jndiDepServiceName = componentDescription.getServiceName().append(JNDI_BINDINGS_SERVICE);

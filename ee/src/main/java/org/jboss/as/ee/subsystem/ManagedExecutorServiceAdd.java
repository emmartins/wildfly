...
public class ManagedExecutorServiceAdd extends AbstractAddStepHandler {
    ...
    protected void performRuntime(OperationContext context, ModelNode operation, ModelNode model) throws OperationFailedException {
        ...
        final ServiceName serviceName = ManagedExecutorServiceResourceDefinition.CAPABILITY.getCapabilityServiceName(name);
        ...
        final ServiceBuilder<ManagedExecutorServiceAdapter> serviceBuilder = context.getServiceTarget().addService(serviceName, service);

...
public class BeanValidationFactoryDeployer implements DeploymentUnitProcessor {
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        final List<BindingConfiguration> bindingConfigurations = moduleDescription.getSharedCompBindingConfigurations();
        bindingConfigurations.add(new BindingConfiguration("java:comp/ValidatorFactory", new FixedInjectionSource(factory)));
        bindingConfigurations.add(new BindingConfiguration("java:comp/Validator", new FixedInjectionSource(new ValidatorJndiInjectable(factory), factory)));
    }

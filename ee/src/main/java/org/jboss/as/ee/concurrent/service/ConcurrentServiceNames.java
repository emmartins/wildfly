...
public class ConcurrentServiceNames {
     ...
     * @param name
     * @return
     * @deprecated Use "org.wildfly.ee.concurrent.threadfactory" dynamic capability's service name instead.
     */
    @Deprecated
     ...
     * @param name
     * @return
     * @deprecated Use "org.wildfly.ee.concurrent.scheduledexecutor" dynamic capability's service name instead.
     */
    @Deprecated

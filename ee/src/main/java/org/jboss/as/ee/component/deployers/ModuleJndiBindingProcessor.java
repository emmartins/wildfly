        ...
        if (bindingName != null) {
            ...
            if (bindingName.startsWith("java:comp") || bindingName.startsWith("java:module") || bindingName.startsWith("java:app")) {
                ...
                if (service instanceof SharedBinderService) {
                    phaseContext.getDeploymentUnit().addToAttachmentList(org.jboss.as.naming.deployment.Attachments.SHARED_BINDER_SERVICES_ACQUIRED, ((SharedBinderService)service).acquire());
                }
            }
        } else {

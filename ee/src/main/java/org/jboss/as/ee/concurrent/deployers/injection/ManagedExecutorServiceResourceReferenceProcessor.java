...
public class ManagedExecutorServiceResourceReferenceProcessor implements EEResourceReferenceProcessor {
    ...
    private static final LookupInjectionSource injectionSource = new LookupInjectionSource("java:comp/"+EEConcurrentDefaultBindingProcessor.DEFAULT_MANAGED_EXECUTOR_SERVICE_JNDI_NAME);

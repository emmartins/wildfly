...
public class JMSDestinationDefinitionAnnotationProcessor extends ResourceDefinitionAnnotationProcessor {
    ...
    protected ResourceDefinitionInjectionSource processAnnotation(AnnotationInstance annotationInstance) throws DeploymentUnitProcessingException {
        ...
        final DirectJMSDestinationInjectionSource directJMSDestinationInjectionSource = new DirectJMSDestinationInjectionSource(jndiName, interfaceName);
        ...
        directJMSDestinationInjectionSource.setDestinationName(AnnotationElement.asOptionalString(annotationInstance, "destinationName"));
        directJMSDestinationInjectionSource.addProperties(AnnotationElement.asOptionalStringArray(annotationInstance, AnnotationElement.PROPERTIES));

...
public class WeldBeanManagerJndiProcessor implements DeploymentUnitProcessor {
    ...
    private static final JndiName JNDI_NAME = new JndiName("java:comp/BeanManager");
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        final BindingConfiguration bindingConfiguration = new BindingConfiguration(JNDI_NAME, serviceInjectionSource);

...
public class ManagedExecutorServiceResourceDefinition extends SimpleResourceDefinition {
    ...
    public static final SimpleAttributeDefinition REJECT_POLICY_AD =
            new SimpleAttributeDefinitionBuilder(REJECT_POLICY, ModelType.STRING, true)
                    .setAllowExpression(true)
                    .setFlags(AttributeAccess.Flag.RESTART_RESOURCE_SERVICES)
                    .setDefaultValue(new ModelNode(RejectPolicy.ABORT.toString()))
                    .setValidator(EnumValidator.create(RejectPolicy.class))
                    .build();
    ...
    static class ExecutorQueueValidationStepHandler implements OperationStepHandler {
        ...
        public void execute(final OperationContext context, final ModelNode operation) throws OperationFailedException {
            ...
            if ((!queueLength.isDefined() || queueLength.asInt() == Integer.MAX_VALUE)
                    ...
                    && coreThreads.asInt() <= 0) {
                throw ConcurrencyLogger.ROOT_LOGGER.invalidCoreThreadsSize(queueLength.asString());
            }
            ...
            if (coreThreads.isDefined()
                ...
                throw ConcurrencyLogger.ROOT_LOGGER.invalidMaxThreads(maxThreads.isDefined() ? maxThreads.asInt() : 0,
                        coreThreads.asInt());
            }
            ...
            if (coreThreads.isDefined()
                ...
                throw ConcurrencyLogger.ROOT_LOGGER.invalidMaxThreads(maxThreads.asInt(), coreThreads.asInt());
            }
        }
    }
}

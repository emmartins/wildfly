...
import org.wildfly.concurrency.adapter.ContextServiceAdapter;
import org.wildfly.concurrency.subsystem.ConcurrencyEESubsystemModel;
import org.wildfly.concurrency.subsystem.ConcurrencyResourceDescriptionResolver;
...
public class ContextServiceResourceDefinition extends SimpleResourceDefinition {
     ...
     */
    public static final RuntimeCapability<Void> CAPABILITY = RuntimeCapability.Builder.of("org.wildfly.ee.concurrent.context.service", true, ContextServiceAdapter.class)
            .build();
    ...
    ContextServiceResourceDefinition() {
        super(new SimpleResourceDefinition.Parameters(PathElement.pathElement(ConcurrencyEESubsystemModel.CONTEXT_SERVICE),
                new ConcurrencyResourceDescriptionResolver(ConcurrencyEESubsystemModel.CONTEXT_SERVICE))

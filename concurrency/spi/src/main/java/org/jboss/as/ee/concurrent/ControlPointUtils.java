...
public class ControlPointUtils {
    ...
    public static Runnable doWrap(Runnable runnable, ControlPoint controlPoint, ProcessStateNotifier processStateNotifier) {
        ...
        if (result == RunResult.REJECTED) {
            throw ConcurrencyLogger.ROOT_LOGGER.rejectedDueToMaxRequests();
        }
        try {
            ...
            if (controlPoint == null) {
                ...
                try {
                    ...
                    if (result == RunResult.RUN) {
                        ...
                        throw ConcurrencyLogger.ROOT_LOGGER.cannotRunScheduledTask(runnable);
                    }
                } catch (RuntimeException re) {
                    // WFLY-13043
                    if (runnableException == null) {
                        ConcurrencyLogger.ROOT_LOGGER.failedToRunTask(runnable,re);
                        return;
                    } else {
                        throw ConcurrencyLogger.ROOT_LOGGER.failureWhileRunningTask(runnable, re);
                    }
                }
            }
        }
            ...
            if (controlPoint == null) {
                ...
                try {
                    ...
                    if (result == RunResult.RUN) {
                        ...
                        throw ConcurrencyLogger.ROOT_LOGGER.cannotRunScheduledTask(callable);
                    }
                } catch (Exception e) {
                    throw ConcurrencyLogger.ROOT_LOGGER.failureWhileRunningTask(callable, e);
                }
            }
        }
    }

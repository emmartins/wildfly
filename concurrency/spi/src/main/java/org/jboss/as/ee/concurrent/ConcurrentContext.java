...
public class ConcurrentContext {
    ...
    public synchronized void addFactory(ContextHandleFactory factory) {
        ...
        if(factoryMap.containsKey(factoryName)) {
            throw ConcurrencyLogger.ROOT_LOGGER.factoryAlreadyExists(this, factoryName);
        }
    ...
    private static class ChainedSetupContextHandle implements SetupContextHandle {
        ...
        private void writeObject(ObjectOutputStream out) throws IOException {
            ...
            for(SetupContextHandle handle : setupHandles) {
                ...
                if(factory == null) {
                    throw ConcurrencyLogger.ROOT_LOGGER.factoryNotFound(concurrentContext, factoryName);
                }
        ...
        private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
            ...
            try {
                ...
                if(serviceController == null) {
                    throw ConcurrencyLogger.ROOT_LOGGER.concurrentContextServiceNotInstalled(serviceName);
                }
            ...
            if(resetHandles != null) {
                for (ResetContextHandle handle : resetHandles) {
                    try {
                        ...
                        ConcurrencyLogger.ROOT_LOGGER.debug("failed to reset handle",e);
                    }
                }
                resetHandles = null;

...
public class EjbOverHttpRemoteServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        final HttpChannel httpChannel = new HttpChannel(response);
        final HttpMessageInputStream httpMessageInputStream = new HttpMessageInputStream(request.getInputStream());

 ...
 * @author Paul Ferraro
 */
public class CacheGroupServiceInstaller implements ClusterServiceInstaller {
    ...
    public Collection<ServiceName> getServiceNames(String group) {
        return Arrays.asList(CacheServiceNames.GROUP.getServiceName(group), createBinding(group).getBinderServiceName());
    }
